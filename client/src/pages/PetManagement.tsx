        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3 min-w-0">
            <div className="rounded-xl bg-ink-800/60 border border-white/5 p-1 shrink-0">
              <PetSprite shapeId={pet.shapeId} element={dominantElement(pet.elementPoints)} size={72} />
            </div>
        ...
        {evo && (
          <div className="panel p-3 space-y-2">
            <div className="flex items-center gap-2">
              <PetSprite shapeId={evo.target} element={dominantElement(pet.elementPoints)} size={40} />
